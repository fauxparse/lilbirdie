...
const selectTriggerVariants = cva(
  "flex w-full items-center justify-between rounded-md border border-input bg-background ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:border-input-focus focus:ring-4 focus:ring-ring focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
  {
    variants: {
      size: {
...
>(({ className, children, indicatorSide = "left", ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      indicatorSide === "left" ? "pl-8 pr-2" : "pr-8 pl-2",
      className
    )}
    {...props}
  >
