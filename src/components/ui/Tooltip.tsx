...
const Provider: React.FC<React.ComponentProps<typeof TooltipPrimitive.Provider>> = ({
  delayDuration = 0,
  ...props
}) => (
...
const Root: React.FC<React.ComponentProps<typeof TooltipPrimitive.Root>> = ({ ...props }) => (
  <Provider>
    <TooltipPrimitive.Root data-slot="tooltip" {...props} />
  </Provider>
);

const Trigger: React.FC<React.ComponentProps<typeof TooltipPrimitive.Trigger>> = ({ ...props }) => (
